...
class CustomUserAdmin(UserAdmin):
    list_display = ('phone_number','otp_value','status','referral_code', 'name','registration_id','walet', 'is_active', 'is_staff')
    list_filter = ('is_active', 'is_staff')
    search_fields = ('phone_number', 'name', 'referral_code')
    ordering = ('phone_number',)

    fieldsets = (
        (None, {'fields': ('phone_number', 'referral_code','email','otp_value', 'password','status')}),
